...
![Version: 0.1.3](https://img.shields.io/badge/Version-0.1.3-informational?style=flat-square) ![AppVersion: v0.13.30](https://img.shields.io/badge/AppVersion-v0.13.30-informational?style=flat-square)

A Helm chart for ckpool
...
| image.repository | string | `"apotdevin/ckpool"` |  |
| image.tag | string | `""` |  |
